...
import { checkButtonTrigger, filterTrigger, formButtonTrigger, highlightedStateTrigger, listStateTrigger, mensagemListaVaziaTrigger, shakeTrigger, shownStateTrigger } from '../animations';
...
@Component({
  ...
  animations: [highlightedStateTrigger, shownStateTrigger, checkButtonTrigger,
    filterTrigger, formButtonTrigger, mensagemListaVaziaTrigger, shakeTrigger,
  listStateTrigger]
})
export class ListaTarefasComponent implements OnInit {
  ...
  filtarTarefaPorDescricao(descricao: string) {
