...
import { checkButtonTrigger, filterTrigger, formButtonTrigger, highlightedStateTrigger, mensagemListaVaziaTrigger, shakeTrigger, shownStateTrigger } from '../animations';
