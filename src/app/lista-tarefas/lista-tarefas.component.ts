...
import { checkButtonTrigger, filterTrigger, formButtonTrigger, highlightedStateTrigger, mensagemListaVaziaTrigger, shownStateTrigger } from '../animations';
...
@Component({
  ...
  animations: [highlightedStateTrigger, shownStateTrigger, checkButtonTrigger,
    filterTrigger, formButtonTrigger, mensagemListaVaziaTrigger]
})
